...
import { Brain, Mail, Phone, MapPin, Clock, MessageSquare, Users, Zap } from 'lucide-react';
                  ...
                  <div className="space-y-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="wellness">Wellness Coordinator</SelectItem>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Most organizations can be up and running within 1-2 weeks. Our implementation 
                  team will guide you through the entire setup process.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Yes, we use enterprise-grade encryption and are HIPAA compliant. Individual 
                  employee data is anonymized and only aggregate insights are shared with employers.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  We integrate with popular HR systems, Slack, Microsoft Teams, and many other 
                  workplace tools. Custom integrations are also available.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 text-sm">
                  Yes, we provide comprehensive training for administrators and ongoing support 
                  to ensure your team gets the most value from the platform.
                </p>
              </CardContent>
            </Card>
          </div>
